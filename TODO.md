...
- [ ] `TRADE-001`: add a seven-good catalog and deterministic city production/consumption projected from authoritative world time over finite stocks, reusing existing food/water stocks and populations.
- [ ] `TRADE-002`: derive transparent bounded buy/sell prices from each city's current stock and target demand without random price rolls.
