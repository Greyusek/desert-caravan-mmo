...
- `CHECKPOINT_42.md` — стабильный первый multi-patrol контакт в публичном expedition contact/outcome API с разрешением не более одного контакта за срез.
...
Текущий статус: `SIM-001..SIM-008`, `WORLD-001..WORLD-004`, `UI-001..UI-006`, `GAME-001..GAME-025` и `CITY-001..CITY-003` покрыты 367 simulation/UI-тестами; вместе с 5 tooling-регрессиями проверка запускает 372 теста. Согласованный блок MVP 0.1 завершён; следующий этап не начат.
