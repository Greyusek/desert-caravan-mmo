...
Текущий статус: `SIM-001..SIM-008`, `WORLD-001..WORLD-004`, `UI-001..UI-006`, `GAME-001..GAME-016` и `CITY-001..CITY-003` покрыты 279 simulation/UI-тестами; вместе с 5 tooling-регрессиями GitHub Actions запускает 284 теста в pull request.
