...
- ранее принятая зона физического взаимодействия: **500 м** — сама по себе не раскрывает скрытый объект; обнаружение на 150 м служит обязательным knowledge gate, после которого объект уже находится внутри interaction radius;
